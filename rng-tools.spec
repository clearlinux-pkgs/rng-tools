...
%prep
%setup -q -n rng-tools-6.15
cd %{_builddir}/rng-tools-6.15
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644431388
...
cp %{_builddir}/rng-tools-6.15/COPYING %{buildroot}/usr/share/package-licenses/rng-tools/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
