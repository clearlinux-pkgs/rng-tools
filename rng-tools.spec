...
Version  : 6.12
Release  : 25
URL      : https://github.com/nhorman/rng-tools/archive/v6.12/rng-tools-6.12.tar.gz
Source0  : https://github.com/nhorman/rng-tools/archive/v6.12/rng-tools-6.12.tar.gz
...
%prep
%setup -q -n rng-tools-6.12
cd %{_builddir}/rng-tools-6.12
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615923011
...
cp %{_builddir}/rng-tools-6.12/COPYING %{buildroot}/usr/share/package-licenses/rng-tools/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
