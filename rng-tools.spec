...
Version  : 6.16
Release  : 30
URL      : https://github.com/nhorman/rng-tools/archive/v6.16/rng-tools-6.16.tar.gz
Source0  : https://github.com/nhorman/rng-tools/archive/v6.16/rng-tools-6.16.tar.gz
...
%prep
%setup -q -n rng-tools-6.16
cd %{_builddir}/rng-tools-6.16
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673473291
